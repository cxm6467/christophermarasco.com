			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="span4">
						...
						<ul>
							<li>I would like to learn the "ins" and "outs" of Microsoft Sharepoint.</li>
						</ul>
						<h4>Mock Business</h4>
						<ul>
							<li>I plan to set up a website for a mock business to delve deeper into PHP and MySQL.</li>
						</ul>
					</div>
				</div>
			</div>
